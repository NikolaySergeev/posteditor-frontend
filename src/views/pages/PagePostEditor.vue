...
class MyUploadAdapter {
    constructor( loader ) {
        ...
        this.url = 'http://posteditor-backend.herokuapp.com/upload';
    }
...
*/
    ...
    export default {
        ...
        mounted() {
           ...
           axios.get(`http://posteditor-backend.herokuapp.com/api/posts/${postId}`).then(response => {
        ...
        methods: {
           ...
           const app = this;
                ...
                axios({
                    method: 'PUT',
                    url: `http://posteditor-backend.herokuapp.com/api/posts/${postId}`,
                    data: {
